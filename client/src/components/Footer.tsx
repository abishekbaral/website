    ...
    <footer className="bg-gray-800 text-white py-12 px-4">
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-8 md:mb-0">
            ...
            <p className="mb-4 text-gray-300">
              Your trusted partner for sustainable e-waste and EV battery management in Nepal.
            </p>
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/process" className="text-gray-300 hover:text-white transition duration-300">Our Process</Link></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Fully Charged Nepal. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
